...
class __TwigTemplate_845421c19090e9e2d64738a4baf8363e extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["field"], "wrapper_element", [], "any", false, false, true, 37)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["field"], "wrapper_attributes", [], "any", false, false, true, 38), 38, $this->source), "html", null, true);
                echo ">";
            }
            // line 40
    ...
    {
        return array (  90 => 53,  88 => 52,  85 => 50,  75 => 48,  73 => 47,  68 => 44,  57 => 42,  55 => 41,  53 => 40,  47 => 38,  45 => 37,  43 => 36,  39 => 34,);
    }
...
{% for field in fields -%}
  ...
  {%- endif %}
{%- endfor %}
", "core/modules/views/templates/views-view-fields.html.twig", "/app/web/core/modules/views/templates/views-view-fields.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("for" => 34, "if" => 37);
